/*
 * webui.h — minimal embedded HTTP server for the SerpentX dashboard.
 *
 ...
 */
#ifndef SERPENTX_WEBUI_H
#define SERPENTX_WEBUI_H
 ...
 * `X-SerpentX-Key: <password>` or query `?key=<password>`). Spawns a detached
